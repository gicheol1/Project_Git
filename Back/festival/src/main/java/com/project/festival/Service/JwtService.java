...
public class JwtService {
	...
	// 토큰 만료 시간: 3시간
    // 1000밀리초(1초) * 60초(1분) * 60분(1시간) * 3시간
    static final long EXPRIATIONTIME = (1000 * 60 * 60 * 3);
...
// ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒
	...
	public String getToken(User user) {
		...
		// 기존에 저장된 토큰 정보 가져오기
        Optional<Token> _token = tokenRepository.findByUser_MemId(user.getMemId());
        ...
        // 이미 존재하는 경우
        if (_token.isPresent()) { updateToken(_token.get(), jti, user); }
        
        // 새로 만드는 경우
        else { saveToken(jti, user); }
...
// ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ ▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒
    ...
    private void saveToken(String jti, User user) {
        ...
        token.setExpirationDate(new Date(System.currentTimeMillis() + EXPRIATIONTIME));
        tokenRepository.save(token);
    }

	// 토큰 업데이트(기본키인 토큰 번호가 null이 아닌 경우 수정(Update)가 된다)
    private void updateToken(Token token, String jti, User user) {
    	token.setJti(jti);
    	token.setUser(user);
    	token.setRole(user.getRole());
    	token.setExpirationDate(new Date(System.currentTimeMillis() + EXPRIATIONTIME));
